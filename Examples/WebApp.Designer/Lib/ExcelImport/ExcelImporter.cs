...
namespace WebApp.Designer.Lib.ExcelImport
{
    internal class ExcelImporter
    {
        ...
        internal string Import(string inputFile)
        {
            ...
            PageFrame.WriteToMain(Path.Combine(GetPageFrameOutputPath(), "Main.frm.json"), modules);
        ...
        internal void Import(List<ModuleDesign> mods)
        {
            ...
            PageFrame.WriteToMain(Path.Combine(GetPageFrameOutputPath(), "Main.frm.json"), mods);
        }
